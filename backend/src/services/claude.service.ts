...
class ClaudeService {
    ...
    private buildSummaryPrompt(text: string, maxLength: number): string {
        return `Please provide a concise summary of the following text. The summary should be no more than ${maxLength} characters and capture the main points clearly.
